...
namespace LanchoneteUDV
{
    public partial class PedidoForm : Form
    {
        ...
        {
            SocioComboBox.DataSource = _bllSocios.ListarSociosVenda();
        ...
        {
            PedidosDataGridView.DataSource = _bllVendasPedido.ListarVendasPedido(IdVenda);
        ...
        private void RecarregarGridEstoque()
        {
            //DataTable 
        ...
        private void RecarregarGridEstoqueSalgados()
        {
            //DataTable 
        ...
        {
            SociosVisitanteForm frm = new SociosVisitanteForm();
            frm.ShowDialog();
            CarregarCombos();
            SocioComboBox.SelectedValue = -1;
